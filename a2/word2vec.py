...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    idx_center = word2Ind[currentCenterWord]
    vec_center = centerWordVectors[idx_center]
    for outwd in outsideWords:
        idx_outwd = word2Ind[outwd]
        newloss, newgradC, newgradOut = word2vecLossAndGradient(
            vec_center, idx_outwd, outsideVectors, dataset)
        loss += newloss
        gradCenterVecs[idx_center] += newgradC
        gradOutsideVectors += newgradOut
    ### YOUR CODE HERE
    ### END YOUR CODE
